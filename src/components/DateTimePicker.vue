<template>
    <zui-popup v-model="visible" position="bottom" class="zui-datetime">
        <zui-picker
                :slots="dateSlots"
                @change="onChange"
                :visible-item-count="visibleItemCount"
                class="zui-datetime-picker"
                ref="picker"
                show-toolbar>
            <span class="zui-datetime-action zui-datetime-cancel" @click="visible = false;$emit('cancel')">{{ cancelText }}</span>
            <span class="zui-datetime-action zui-datetime-confirm" @click="confirm">{{ confirmText }}</span>
        </zui-picker>
    </zui-popup>
</template>
...
<style>
    ...
    .zui-datetime .picker-slot-wrapper, .zui-datetime .picker-item {
        -webkit-backface-visibility: hidden;
        backface-visibility: hidden;
    }
    .zui-datetime .picker-toolbar {
