<template>
    <div class="zui-swipe">
        <div class="zui-swipe-items-wrap" ref="wrap">
            <slot></slot>
        </div>
        <div class="zui-swipe-indicators" v-show="showIndicators">
            <div class="zui-swipe-indicator"
...
<style>
    ...
    .zui-swipe-items-wrap {
        position: relative;
        overflow: hidden;
        width: 100%;
    }
    .zui-swipe-items-wrap > div {
        position: absolute;
    ...
    .zui-swipe-items-wrap > div.is-active {
        display: block;
        -webkit-transform: none;
        transform: none;
    }
    .zui-swipe-indicators {
